    ...
    return (
      <Router>
        <div>
          ...
          <MuiThemeProvider><Route exact path="/products/categories" component={ Categories } /></MuiThemeProvider>
          <MuiThemeProvider><Route exact path="/products" component={ Products } /></MuiThemeProvider>
